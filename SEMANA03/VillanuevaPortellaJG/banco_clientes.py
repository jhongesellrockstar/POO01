class Cliente:
    def __init__(self, nombre):
        self.nombre = nombre; self.monto = 0
    def depositar(self, monto): self.monto += monto
    def extraer(self, monto):   self.monto -= monto
    def retornar_monto(self):   return self.monto
    def imprimir(self):
...
class Banco:
    ...
    def depositos_totales(self):
        ...
        self.cliente1.imprimir(); self.cliente2.imprimir(); self.cliente3.imprimir()
